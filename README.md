# Graphical AI Tutor (`AI_TUTOR`) & Excalidraw MCP Server

[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Tests](https://img.shields.io/badge/tests-passing-brightgreen.svg)](tests/)
[![PRD & Architecture](https://img.shields.io/badge/docs-PRD%20%7C%20Architecture-blue.svg)](docs/)

> **Interactive, Visual-First AI Whiteboard Tutor for Students and Developers.**  
> Built on top of Excalidraw with Socratic step-by-step pedagogy, real-time vector diagramming, Edge Neural voice synthesis, and multi-provider Bring-Your-Own-Key (BYOK) AI model support.

📖 **For installation, setup, and usage instructions, see [howtouse.md](howtouse.md).**  
📚 **For detailed architecture, PRD, and design decisions, see the [docs/](docs/) directory.**

---

## What is Graphical AI Tutor?

**Graphical AI Tutor** is an interactive learning platform where an AI teacher illustrates concepts live on a whiteboard while explaining them step-by-step. Instead of static textbook paragraphs or one-off images, the tutor outputs native, editable Excalidraw vector shapes, arrows, notes, and visual symbols that smoothly pan and highlight as the lesson progresses.

- 🎓 **Socratic Pedagogy**: Lessons broken down into *What It Is*, *How It Works*, *Why We Need It*, and *Whiteboard Visuals*.
- 📊 **Adaptive Learning Levels**: Switch seamlessly between **Beginner**, **Intermediate**, and **Pro** modes.
- 🎨 **Native Excalidraw Drawing**: Live vector whiteboard with bound containers, routing arrows, and educational symbols.
- 🎙️ **Voice & Neural Speech**: Edge Neural text-to-speech (English & Urdu) and browser speech-to-text voice input.
- 🔑 **Universal BYOK (Bring Your Own Key)**: Choose from 400+ OpenRouter models (including 20+ free tier models), OpenAI, Anthropic, Gemini, Groq, or local offline Ollama. Keys stay securely in client `localStorage`.
- 🛠️ **Full MCP Engine**: Includes 26 MCP tools over stdio and REST endpoints to integrate with Claude Desktop, Cursor, Antigravity, and coding agents.

---

## Demo

![AI agent drawing on live Excalidraw canvas](demo.gif)
